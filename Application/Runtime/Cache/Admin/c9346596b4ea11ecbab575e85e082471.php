            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$menu): ?><option value="<?php echo ($menu["menu_id"]); ?>" <?php if($menu["menu_id"] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($menu["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
