                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <tbody>
                          <?php if(is_array($adminlist)): $i = 0; $__LIST__ = $adminlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span  attr-status="<?php if($admin['status'] == 1): ?>0<?php else: ?>1<?php endif; ?>"  attr-id="<?php echo ($admin["admin_id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off" ><?php echo (getStatus($admin["status"])); ?></span></td>
